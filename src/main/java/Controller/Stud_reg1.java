...
/**
 * Servlet implementation class Stud_reg1
 */
@WebServlet("/Stud_reg1")
public class Stud_reg1 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		HttpSession session2=request.getSession(false);  
		 int sid=(Integer)session2.getAttribute("sid");
		 ...
		 try{  
			 String a1="",a2="",a3="",a4="",a5="",a6="",a7="",a8="",a9="";
				...
				ResultSet rs=stmt.executeQuery("select * from student_reg where sid='"+sid+"'");  
				...
				out.print("<!DOCTYPE html>\r\n"
						...
						+ "       <Div class=\"tab\">\r\n"
						+ "        <div class=\"anc\">\r\n"
						+ "        <a href=\"staff_edit\">Edit Details</a>\r\n"
